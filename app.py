...
openai.api_key = st.secrets["OPENAI_API_KEY"]  # Oder direkt eintragen: openai.api_key = "sk-..."

# === Konfiguration ===
st.set_page_config(page_title="Sanierungsfahrplan", page_icon="🏡", layout="centered")

PASSWORT = "dein_passwort"  # Passwort anpassen
...
st.title("🏠 KI-gestützter Sanierungsfahrplan")
...
# === Analyse & Ausgabe ===
if abgeschickt:
    with st.spinner("🔍 KI analysiert das Gebäude..."):
